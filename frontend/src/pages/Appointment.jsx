      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div>
            {/* image */}
            <img
              className="bg-[#5F6FFF]/90 w-full sm:max-w-72 rounded-lg "
              src={docInfo.image}
              alt=""
            />
          </div>
          <div className="flex flex-1 flex-col border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            ...
            <div className="flex items-center gap-2 text-sm mt-1 text-gray-600">
              ...
              <h3 className="border border-gray-900 rounded-full px-2 py-0.5 text-nowrap">
                {docInfo.experience}
              </h3>
            </div>
            ...
            <h1 className="text-gray-500 font-medium mt-4">
              Appointment Fee:{" "}
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
          ...
          <button
            ...
            className="bg-[var(--primary)] text-white text-sm font-light px-14 py-3 rounded-full my-6 cursor-pointer hover:bg-[#444a7d] duration-200"
          >
            Book an Appointment
          </button>
        </div>
