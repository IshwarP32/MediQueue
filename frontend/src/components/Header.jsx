    ...
    <div className='flex flex-col md:flex-row flex-wrap bg-[#5F6FFF] rounded-lg px-6 md:px-10 lg:px-20'>
        ...
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[30px]'>
            <p className='text-3xl md:text-4xl lg:text-5xl text-white font-semibold leading-tight'>
                Book Appointment <br/>
                With Trusted Docotors
            </p>
            <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
                <img src={assets.group_profiles} className='w-28' />
                <p>Simply brouse through our extensive list of trusted doctors, <br className='hidden sm:block'/> Schedule your appointment hassle-free.</p>
            </div>
